...
const DashboardSidebar: React.FC<DashboardSidebarProps> = ({
  activePage,
  onPageChange,
  userRole = "user", // По умолчанию обычный пользователь
}) => {
  ...
  const mainItems = [
    {
      id: "management",
      label: "Управление",
      icon: "icons/management-icon.svg",
      iconActive: "icons/management-white.svg",
    },
    {
      id: "tariff",
      label: "Мой тариф",
      icon: "icons/tariff-icon.svg",
      iconActive: "icons/tariff-white.svg",
    },
    {
      id: "last-donations",
      label: "Последние донаты",
      icon: "icons/donations-icon.svg",
      iconActive: "icons/donations-white.svg",
    },
    {
      id: "news",
      label: "Новости",
      icon: "icons/news-icon.svg",
      iconActive: "icons/news-white.svg",
    },
  ];

  // Админ-панель доступна только для админов и главных админов
  const adminItems =
      ...
      ? [
          {
            ...
            iconActive: "icons/admin-icon.svg",
          },
        ]
      : [];
  ...
  const widgetsItems = [
    {
      ...
      iconActive: "icons/notifications-white.svg",
    },
    {
      id: "goal",
      label: "Цель сбора",
      icon: "icons/goal-icon.svg",
      iconActive: "icons/goal-white.svg",
    },
    {
      id: "statistics",
      label: "Статистика",
      icon: "icons/statistics-icon.svg",
      iconActive: "icons/statistics-white.svg",
    },
    {
      id: "video",
      label: "Видео",
      icon: "icons/video-icon.svg",
      iconActive: "icons/video-white.svg",
    },
    {
      id: "hotkeys",
      label: "Горячие клавиши",
      icon: "icons/hotkeys-icon.svg",
      iconActive: "icons/hotkeys-white.svg",
    },
    {
      id: "roulette",
      label: "Рулетка",
      icon: "icons/roulette-icon.svg",
      iconActive: "icons/roulette-white.svg",
    },
  ];
  ...
  const cabinetItems = [
    ...
    },
    {
      ...
      iconActive: "icons/support-white.svg",
    },
  ];
