...
public class UserController {
        ...
        public ResponseEntity<Map<String, Object>> getProfile(
                ...
                profileMap.put("displayName",
                                user.getDisplayName() != null ? user.getDisplayName() : user.getUsername());
                profileMap.put("channelUrl", user.getChannelUrl() != null ? user.getChannelUrl() : "");
                profileMap.put("kaspiPhone", user.getKaspiPhone() != null ? user.getKaspiPhone() : "");
                profileMap.put("role", user.getRole() != null ? user.getRole() : "USER");
                profileMap.put("subscriptionTier", user.getSubscriptionTier());
                profileMap.put("subscriptionStartAt", user.getSubscriptionStartAt());
                profileMap.put("subscriptionExpiresAt", user.getSubscriptionExpiresAt());
                profileMap.put("isSubscriptionActive",
                                user.getIsSubscriptionActive() != null ? user.getIsSubscriptionActive() : false);
                profileMap.put("createdAt", user.getCreatedAt());
        ...
        public ResponseEntity<VoiceSettingsResponse> updateVoiceSettings(
                ...
                log.info("Voice settings updated for user: {}, enabled: {}, minAmount: {}, language: {}, type: {}, volume: {}",
                                user.getUsername(), request.getVoiceEnabled(), request.getVoiceMinAmount(),
                                request.getVoiceLanguage(),
        ...
        public ResponseEntity<ModerationSettingsResponse> getModerationSettings(
                ...
                ModerationSettingsResponse response = ModerationSettingsResponse.builder()
                                .moderationEnabled(user.getModerationEnabled() != null ? user.getModerationEnabled()
                                                : false)
        ...
        public ResponseEntity<ModerationSettingsResponse> updateModerationSettings(
                ...
                try {
                        bannedWordsJson = objectMapper.writeValueAsString(
                                        request.getBannedWords() != null ? request.getBannedWords()
                                                        : java.util.List.of());
                } catch (JsonProcessingException e) {
         ...
         * Обновить цель сбора
         * 
         * @deprecated Используйте POST /api/goals для создания новых целей или PUT
         *             /api/goals/{id} для обновления
         */
        @PutMapping("/goal")
        @Deprecated
        ...
        public ResponseEntity<Map<String, String>> deleteGoal(
                ...
                return ResponseEntity.status(410).body(
                                Map.of("message",
                                                "This endpoint is deprecated. Please use DELETE /api/goals/{id} instead."));
        }
